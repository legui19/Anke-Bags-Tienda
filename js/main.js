...
// ---------------- VARIABLES DE ESTRUCTURA HTML ESTATICA--------------//
        ...
        <div class="categorias">
            ...
            <form onsubmit="return false" class="categoriasCheckbox">
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="CARTERA" id="CARTERA" type="radio">
                    <label for="CARTERA">Cartera</label>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="BANDOLERA" id="BANDOLERA" type="radio">
                    <label for="BANDOLERA">Bandolera</label>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="BILLETERA" id="BILLETERA" type="radio">
                    <label for="BILLETERA">Billetera</label>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="BOLSO" id="BOLSO" type="radio">
                    <label for="BOLSO">Bolso</label>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="MATERA" id="MATERA" type="radio">
                    <label for="MATERA">Matera</label>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <input name="identificador" value="RINIONERA" id="RINIONERA" type="radio">
                    <label for="RINIONERA">Riñonera</label>
                </div>
...
let precioRango = $(`
    ...
    <form onsubmit="return false" class="precioRange d-flex flex-column">
        ...
        <input id="rangeSlider_inversed" type="range" min="1000" max="10000" value="1000"></input>
        <output>3000</output>
        <label for="rangeSlider">Máximo:</label>
        <input id="rangeSlider" type="range" min="5000" max="10000" value="10000"></input>
        <output>6000</output>
        <input class="btn btn-primary" type="submit" value="Aplicar">
    </div>
    `
        ...
        <div class="datosPersonales_finalizarCompra col-md-7">
            ...
            <form onsubmit="return false" class="finalizarCompraForm">
                <div class="form-group">
                    ...
                    <input class="form-control"  type="text" id="nombre" value="Enrique Flores">
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control"  type="email" id="email" value="enrique_flores75@email.com">
                </div>
                <div class="form-group d-flex flex-row justify-content-between flex-wrap telefono">
                    <label class="w-100" for="tel" >Telefono</label>
                    <input class="form-control"  type="text" value="15478895" id="tel">
                </div>
                ...
                <div class="tarjeta_finalizarCompra">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-7 izquierda_tarjeta">
                            ...
                            <input class="numeroDeTarjeta" type="text" name="" id="creditCardNumber" value="1520-48357-7391-4231">
                            <label for="creditCardName">Nombre</label>
                            <input type="text" name="" id="creditCardName" value="FLORES ENRIQUE">
...
// ------------- MOSTRAR DESTACADOS -----------//
    ...
    $.when( dolarAjaxCall() , productosAjaxCall() ).done( () => {
        ...
        $('.grid-container').prepend('<h3 class="col-md-12">Nuestros Productos</h3>');
    })
    ...
    $('aside').on('submit', 'form.categoriasCheckbox', (e) => { 
        ...
        for (const iterator of e.target) {
            ...
            if (iterator.checked === true) {
                ...
                let elValueCheckedMother = elValueCheckedSinGuion.replaceAll('', '').replaceAll('', '').replaceAll('', '')
...
// CIERRA EL FILRO AL SER UTILIZADO Y AGREGA BOTÓN PARA ABRÍR EL FILTRO
...
// ------------- MOSTRAR Y OCULTAR EL CARRITO--------------//
    ...
    //PREVIENE QUE EL CARRITO SE CIERRE CUANDO SE HACE CLIC EN DENTRO DEL CARRITO DESPLEGADO
...
let crearEstructura =  (producto, donde) => {
    let precioEnPesos = producto.precio
